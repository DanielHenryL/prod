...
def imprimir_factura_list(request, f1, f2):
    ...
    # tranformar de formato texto a formato fecha se usa parse_date
    f1 = parse_date(f1)
    f2 = parse_date(f2)
    f2 = f2 + timedelta(days=1)

    # se filtrata si la fecha es mayo o igual 'fecha__gte' y menor 'fecha__lt' a f1 y f2 respectivamente
